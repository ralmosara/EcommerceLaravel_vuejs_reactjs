import { AlbumFormat, OrderStatus, PaymentStatus, UserRole } from '@/api/types/models'
...
export const FORMAT_LABELS = ALBUM_FORMAT_LABELS

// Format Colors (Tailwind classes)
export const ALBUM_FORMAT_COLORS: Record<AlbumFormat, string> = {
  [AlbumFormat.VINYL]: 'bg-purple-900 text-purple-300',
  [AlbumFormat.CD]: 'bg-blue-900 text-blue-300',
  [AlbumFormat.CASSETTE]: 'bg-amber-900 text-amber-300',
  [AlbumFormat.DIGITAL]: 'bg-green-900 text-green-300',
}
...
export const ORDER_STATUS_COLORS: Record<OrderStatus, string> = {
  ...
  [OrderStatus.PROCESSING]: 'bg-blue-900 text-blue-300',
  [OrderStatus.SHIPPED]: 'bg-purple-900 text-purple-300',
  [OrderStatus.DELIVERED]: 'bg-green-900 text-green-300',
  [OrderStatus.CANCELLED]: 'bg-gray-700 text-gray-300',
  [OrderStatus.REFUNDED]: 'bg-red-900 text-red-300',
}
...
export const PAYMENT_STATUS_COLORS: Record<PaymentStatus, string> = {
  ...
  [PaymentStatus.PROCESSING]: 'bg-blue-900 text-blue-300',
  [PaymentStatus.SUCCEEDED]: 'bg-green-900 text-green-300',
  [PaymentStatus.FAILED]: 'bg-red-900 text-red-300',
  [PaymentStatus.REFUNDED]: 'bg-purple-900 text-purple-300',
  [PaymentStatus.CANCELLED]: 'bg-gray-700 text-gray-300',
}
