    ...
    <div class="max-w-md w-full">
      ...
      <div class="text-center mb-8">
        ...
        <p class="mt-2 text-gray-400">
          ...
          <RouterLink to="/register" class="text-punk-orange hover:text-punk-coral transition-colors font-medium">
            Sign up
          </RouterLink>
        </p>
      </div>
      ...
      <div class="bg-punk-gray rounded-lg p-8 border border-gray-700">
          ...
          <div class="flex items-center justify-between">
            <label class="flex items-center">
              <input
                ...
                type="checkbox"
                class="w-4 h-4 rounded border-gray-700 bg-punk-black text-punk-orange focus:ring-punk-orange focus:ring-offset-punk-gray"
              />
              <span class="ml-2 text-sm text-gray-400">Remember me</span>
            </label>
            <RouterLink to="/forgot-password" class="text-sm text-punk-orange hover:text-punk-coral transition-colors">
              Forgot password?
            </RouterLink>
          </div>
        ...
        <div class="relative my-6">
          ...
          <div class="relative flex justify-center text-sm">
            <span class="px-4 bg-punk-gray text-gray-500">Or continue with</span>
          </div>
        </div>
